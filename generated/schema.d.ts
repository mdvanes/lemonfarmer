...
export interface external {
  ...
  "../models/Faction.json": {
    ...
    symbol: external["../models/FactionSymbols.json"];
  ...
  "../models/JumpGate.json": {
    ...
    connectedSystems: (external["../models/ConnectedSystem.json"])[];
  }
  "../models/Market.json": {
  ...
  "../models/ShipNavRoute.json": {
    ...
    departure: external["../models/ShipNavRouteWaypoint.json"];
    /**
     * Format: date-time 
  ...
  register: {
    requestBody?: {
      content: {
        "application/json": {
          /** @example COSMIC */
          faction: external["../models/FactionSymbols.json"];
          /**
