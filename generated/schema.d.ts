...
export interface external {
  ...
  "../models/Agent.json": {
    ...
    readonly startingFaction: string;
  ...
  "../models/ConnectedSystem.json": {
    ...
    readonly symbol: string;
    readonly type: external["../models/SystemType.json"];
  ...
  "../models/Contract.json": {
     ...
     */
    readonly deadlineToAccept?: string;
    /**
     * Format: date-time 
     * @deprecated 
    ...
    readonly terms: external["../models/ContractTerms.json"];
    /**
     * @description Type of contract. 
     * @enum {string}
     */
    readonly type: "PROCUREMENT" | "TRANSPORT" | "SHUTTLE";
  }
  ...
  "../models/ContractTerms.json": {
    ...
    readonly deliver?: readonly (external["../models/ContractDeliverGood.json"])[];
    /** @description Payments for the contract. */
    readonly payment: external["../models/ContractPayment.json"];
  }
  ...
  "../models/Extraction.json": {
    ...
    readonly yield: external["../models/ExtractionYield.json"];
  }
  "../models/ExtractionYield.json": {
    /** @description Symbol of the good that was extracted. */
    readonly symbol: external["../models/TradeSymbol.json"];
  ...
  "../models/Faction.json": {
    ...
    readonly symbol: external["../models/FactionSymbols.json"];
    /** @description List of traits that define this faction. */
    readonly traits: readonly (external["../models/FactionTrait.json"])[];
  }
  "../models/FactionSymbols.json": "COSMIC" | "VOID" | "GALACTIC" | "QUANTUM" | "DOMINION" | "ASTRO" | "CORSAIRS" | "OBSIDIAN" | "AEGIS" | "UNITED" | "SOLITARY" | "COBALT" | "OMEGA" | "ECHO" | "LORDS" | "CULT" | "ANCIENTS" | "SHADOW" | "ETHEREAL"
  ...
  "../models/JumpGate.json": {
    ...
    readonly connectedSystems: readonly (external["../models/ConnectedSystem.json"])[];
  ...
  "../models/Market.json": {
    ...
    readonly exchange: readonly (external["../models/TradeGood.json"])[];
    /** @description The list of goods that are exported from this market. */
    readonly exports: readonly (external["../models/TradeGood.json"])[];
    /** @description The list of goods that are sought as imports in this market. */
    readonly imports: readonly (external["../models/TradeGood.json"])[];
    ...
    readonly tradeGoods?: readonly (external["../models/MarketTradeGood.json"])[];
    /** @description The list of recent transactions at this market. Visible only when a ship is present at the market. */
    readonly transactions?: readonly (external["../models/MarketTransaction.json"])[];
  }
  "../models/MarketTradeGood.json": {
     ...
     * @enum {string}
     */
    readonly supply: "SCARCE" | "LIMITED" | "MODERATE" | "ABUNDANT";
  ...
  "../models/ScannedShip.json": {
    ...
    readonly nav: external["../models/ShipNav.json"];
    /** @description The reactor of the ship. */
    readonly reactor?: {
      /** @description The symbol of the reactor. */
      readonly symbol: string;
    };
    readonly registration: external["../models/ShipRegistration.json"];
  ...
  "../models/ScannedWaypoint.json": {
    readonly chart?: external["../models/Chart.json"];
    readonly faction?: external["../models/WaypointFaction.json"];
    /** @description List of waypoints that orbit this waypoint. */
    readonly orbitals: readonly (external["../models/WaypointOrbital.json"])[];
    /** @description Symbol of the waypoint. */
    readonly symbol: string;
    /** @description Symbol of the system. */
    readonly systemSymbol: string;
    /** @description The traits of the waypoint. */
    readonly traits: readonly (external["../models/WaypointTrait.json"])[];
    readonly type: external["../models/WaypointType.json"];
    /** @description Position in the universe in the x axis. */
    readonly x: number;
    /** @description Position in the universe in the y axis. */
    readonly y: number;
  ...
  "../models/Ship.json": {
    readonly cargo: external["../models/ShipCargo.json"];
    readonly crew: external["../models/ShipCrew.json"];
    readonly engine: external["../models/ShipEngine.json"];
    readonly frame: external["../models/ShipFrame.json"];
    readonly fuel: external["../models/ShipFuel.json"];
    /** @description Modules installed in this ship. */
    readonly modules: readonly (external["../models/ShipModule.json"])[];
    /** @description Mounts installed in this ship. */
    readonly mounts: readonly (external["../models/ShipMount.json"])[];
    readonly nav: external["../models/ShipNav.json"];
    readonly reactor: external["../models/ShipReactor.json"];
    readonly registration: external["../models/ShipRegistration.json"];
  ...
  "../models/ShipCargo.json": {
    ...
    readonly inventory: readonly (external["../models/ShipCargoItem.json"])[];
  ...
  "../models/ShipCrew.json": {
     ...
     * @enum {string}
     */
    readonly rotation: "STRICT" | "RELAXED";
  ...
  "../models/ShipEngine.json": {
    readonly condition?: external["../models/ShipCondition.json"];
    /** @description The description of the engine. */
    readonly description: string;
    /** @description The name of the engine. */
    readonly name: string;
    readonly requirements: external["../models/ShipRequirements.json"];
     ...
     * @enum {string}
     */
    readonly symbol: "ENGINE_IMPULSE_DRIVE_I" | "ENGINE_ION_DRIVE_I" | "ENGINE_ION_DRIVE_II" | "ENGINE_HYPER_DRIVE_I";
  }
  "../models/ShipFrame.json": {
    ...
    readonly mountingPoints: number;
     ...
     * @enum {string}
     */
    readonly symbol: "FRAME_PROBE" | "FRAME_DRONE" | "FRAME_INTERCEPTOR" | "FRAME_RACER" | "FRAME_FIGHTER" | "FRAME_FRIGATE" | "FRAME_SHUTTLE" | "FRAME_EXPLORER" | "FRAME_MINER" | "FRAME_LIGHT_FREIGHTER" | "FRAME_HEAVY_FREIGHTER" | "FRAME_TRANSPORT" | "FRAME_DESTROYER" | "FRAME_CRUISER" | "FRAME_CARRIER";
  }
  ...
  "../models/ShipMount.json": {
    ...
    readonly deposits?: readonly ("QUARTZ_SAND" | "SILICON_CRYSTALS" | "PRECIOUS_STONES" | "ICE_WATER" | "AMMONIA_ICE" | "IRON_ORE" | "COPPER_ORE" | "SILVER_ORE" | "ALUMINUM_ORE" | "GOLD_ORE" | "PLATINUM_ORE" | "DIAMONDS" | "URANITE_ORE" | "MERITIUM_ORE")[];
  ...
  "../models/ShipNav.json": {
    readonly flightMode: external["../models/ShipNavFlightMode.json"];
    readonly route: external["../models/ShipNavRoute.json"];
    readonly status: external["../models/ShipNavStatus.json"];
  ...
  "../models/ShipNavRoute.json": {
    ...
    readonly departure: external["../models/ShipNavRouteWaypoint.json"];
    /**
     * Format: date-time 
     * @description The date time of the ship's departure.
     */
    readonly departureTime: string;
    readonly destination: external["../models/ShipNavRouteWaypoint.json"];
  }
  ...
  "../models/ShipReactor.json": {
     ...
     * @enum {string}
     */
    readonly symbol: "REACTOR_SOLAR_I" | "REACTOR_FUSION_I" | "REACTOR_FISSION_I" | "REACTOR_CHEMICAL_I" | "REACTOR_ANTIMATTER_I";
  }
  "../models/ShipRegistration.json": {
    ...
    readonly name: string;
    readonly role: external["../models/ShipRole.json"];
  }
  ...
  "../models/ShipType.json": "SHIP_PROBE" | "SHIP_MINING_DRONE" | "SHIP_INTERCEPTOR" | "SHIP_LIGHT_HAULER" | "SHIP_COMMAND_FRIGATE" | "SHIP_EXPLORER" | "SHIP_HEAVY_FREIGHTER" | "SHIP_LIGHT_SHUTTLE" | "SHIP_ORE_HOUND" | "SHIP_REFINING_FREIGHTER"
  "../models/Shipyard.json": {
    /** @description The ships that are currently available for purchase at the shipyard. */
    readonly ships?: readonly (external["../models/ShipyardShip.json"])[];
    /** @description The list of ship types available for purchase at this shipyard. */
    readonly shipTypes: readonly ({
        readonly type?: external["../models/ShipType.json"];
      })[];
    ...
    readonly transactions?: readonly (external["../models/ShipyardTransaction.json"])[];
  }
  ...
  "../models/Survey.json": {
    ...
    readonly deposits: readonly (external["../models/SurveyDeposit.json"])[];
    /**
     * Format: date-time 
     ...
     * @enum {string}
     */
    readonly size: "SMALL" | "MODERATE" | "LARGE";
  ...
  "../models/System.json": {
    ...
    readonly factions: readonly (external["../models/SystemFaction.json"])[];
    ...
    readonly waypoints: readonly (external["../models/SystemWaypoint.json"])[];
    /** @description Position in the universe in the x axis. */
    readonly x: number;
    /** @description Position in the universe in the y axis. */
    readonly y: number;
  ...
  "../models/WaypointType.json": "PLANET" | "GAS_GIANT" | "MOON" | "ORBITAL_STATION" | "JUMP_GATE" | "ASTEROID_FIELD" | "NEBULA" | "DEBRIS_FIELD" | "GRAVITY_WELL"
}
...
export interface operations {
        ...
        content: {
          readonly "application/json": {
            ...
            readonly leaderboards: {
              ...
              readonly mostSubmittedCharts: readonly ({
                  /** @description Symbol of the agent. */
                  readonly agentSymbol: string;
  ...
  "get-factions": {
    ...
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: readonly (external["../models/Faction.json"])[];
            readonly meta: external["../models/Meta.json"];
          };
        };
      };
    };
  ...
  "get-faction": {
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: external["../models/Faction.json"];
          };
        };
      };
    };
  ...
  "get-my-agent": {
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: external["../models/Agent.json"];
          };
        };
      };
    };
  ...
  "get-contracts": {
    ...
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: readonly (external["../models/Contract.json"])[];
            readonly meta: external["../models/Meta.json"];
          };
        };
      };
  ...
  "get-contract": {
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: external["../models/Contract.json"];
          };
        };
      };
    };
    ...
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: {
              readonly agent: external["../models/Agent.json"];
              readonly contract: external["../models/Contract.json"];
            };
          };
        };
      };
  ...
  "get-my-ships": {
    ...
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: readonly (external["../models/Ship.json"])[];
            readonly meta: external["../models/Meta.json"];
          };
        };
      };
  ...
  "purchase-ship": {
    readonly requestBody?: {
      readonly content: {
        readonly "application/json": {
          readonly shipType: external["../models/ShipType.json"];
      ...
      201: {
        content: {
          readonly "application/json": {
            readonly data: {
              readonly agent: external["../models/Agent.json"];
              readonly ship: external["../models/Ship.json"];
              readonly transaction: external["../models/ShipyardTransaction.json"];
            };
          };
        };
      };
  ...
  "get-my-ship": {
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: external["../models/Ship.json"];
          };
        };
      };
    };
  ...
  "get-my-ship-cargo": {
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: external["../models/ShipCargo.json"];
          };
        };
      };
    };
      ...
      201: {
        content: {
          readonly "application/json": {
            readonly data: {
              readonly chart: external["../models/Chart.json"];
              readonly waypoint: external["../models/Waypoint.json"];
            };
          };
        };
      };
  ...
  "get-ship-cooldown": {
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: external["../models/Cooldown.json"];
          };
        };
      };
  ...
  "extract-resources": {
    readonly requestBody?: {
      readonly content: {
        readonly "application/json": {
          readonly survey?: external["../models/Survey.json"];
        };
      };
    };
    responses: {
      ...
      201: {
        content: {
          readonly "application/json": {
            readonly data: {
              readonly cargo: external["../models/ShipCargo.json"];
              readonly cooldown: external["../models/Cooldown.json"];
              readonly extraction: external["../models/Extraction.json"];
            };
          };
        };
      };
  ...
  "get-mounts": {
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: readonly (external["../models/ShipMount.json"])[];
          };
        };
      };
    };
        ...
        content: {
          readonly "application/json": {
            readonly data: {
              ...
              readonly mounts: readonly (external["../models/ShipMount.json"])[];
              readonly transaction: external["../models/ShipModificationTransaction.json"];
            };
          };
        };
      };
  ...
  "get-ship-nav": {
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: external["../models/ShipNav.json"];
          };
        };
      };
    };
        ...
        content: {
          readonly "application/json": {
            readonly data: {
              readonly agent: external["../models/Agent.json"];
              readonly cargo: external["../models/ShipCargo.json"];
              readonly transaction: external["../models/MarketTransaction.json"];
            };
          };
        };
      };
    ...
    readonly requestBody?: {
      readonly content: {
        readonly "application/json": {
           ...
           * @enum {string}
           */
          readonly produce: "IRON" | "COPPER" | "SILVER" | "GOLD" | "ALUMINUM" | "PLATINUM" | "URANITE" | "MERITIUM" | "FUEL";
        };
      };
    };
    responses: {
        ...
        content: {
          readonly "application/json": {
            readonly data: {
              ...
              readonly ships: readonly (external["../models/ScannedShip.json"])[];
            };
          };
        };
      };
        ...
        content: {
          readonly "application/json": {
            readonly data: {
              ...
              readonly systems: readonly (external["../models/ScannedSystem.json"])[];
            };
          };
        };
      };
        ...
        content: {
          readonly "application/json": {
            readonly data: {
              ...
              readonly waypoints: readonly (external["../models/ScannedWaypoint.json"])[];
            };
          };
        };
      };
        ...
        content: {
          readonly "application/json": {
            readonly data: {
              ...
              readonly surveys: readonly (external["../models/Survey.json"])[];
            };
          };
        };
      };
    ...
    readonly requestBody?: {
      readonly content: {
        readonly "application/json": {
          ...
          readonly shipSymbol: string;
          readonly tradeSymbol: external["../models/TradeSymbol.json"];
    ...
    readonly requestBody?: {
      readonly content: {
        readonly "application/json": {
          ...
          /** @example COSMIC */
          readonly faction: external["../models/FactionSymbols.json"];
          /**
        ...
        content: {
          readonly "application/json": {
            readonly data: {
              readonly agent: external["../models/Agent.json"];
              readonly contract: external["../models/Contract.json"];
              readonly faction: external["../models/Faction.json"];
              readonly ship: external["../models/Ship.json"];
  ...
  "get-systems": {
    ...
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: readonly (external["../models/System.json"])[];
            readonly meta: external["../models/Meta.json"];
          };
        };
      };
  ...
  "get-system": {
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: external["../models/System.json"];
          };
        };
      };
    };
  ...
  "get-system-waypoints": {
    ...
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: readonly (external["../models/Waypoint.json"])[];
            readonly meta: external["../models/Meta.json"];
          };
        };
      };
  ...
  "get-waypoint": {
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: external["../models/Waypoint.json"];
          };
        };
      };
    };
  ...
  "get-jump-gate": {
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: external["../models/JumpGate.json"];
          };
        };
      };
    };
  ...
  "get-market": {
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: external["../models/Market.json"];
          };
        };
      };
    };
  ...
  "get-shipyard": {
    responses: {
      ...
      200: {
        content: {
          readonly "application/json": {
            readonly data: external["../models/Shipyard.json"];
          };
        };
      };
    };
